	...
	<nav class="navbar navbar-inverse">
	    <ul class="nav navbar-nav">
	        ...
	        <li><a href="{{ URL::to('task/create') }}">Add task</a>
	       	<li><a href="#addSong" class="btn btn-success" data-toggle="modal"><span>Add task</span></a></li>
	    </ul>
	</nav>
    ...
    <table class="table table-striped table-hover">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class=>
                    <a class="" href="{{ URL::to('task/' . $task->id . '/edit') }}"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
